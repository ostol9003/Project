...
<body>
        ...
        <div class="row gy-3">
            <div class="col-sm-12 col-md-6 col-lg-4">
                <a href="/categories" style="text-decoration:none">
                    <div class="card">
                        <div class="card-body">
                            <p class="card-title h5 text-black clearfix">Categories</p>
                        </div>
                    </div>
                </a>
            </div>
    ...
    <div class="container">
        <div class="row gy-3">
            <div class="col-sm-12 col-md-6 col-lg-4">
                <a href="/recipe-category" style="text-decoration:none">
                    <div class="card">
                        <div class="card-body">
        ...
        <div class="row gy-3">
            <div class="col-sm-12 col-md-6 col-lg-4">
                <a href="/recipe-ingredient" style="text-decoration:none">
                    <div class="card">
                        <div class="card-body">
                            <p class="card-title h5 text-black clearfix">Recipes-Ingredients</p>
                        </div>
                    </div>
                </a>
            </div>
